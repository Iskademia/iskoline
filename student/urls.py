...
urlpatterns = [
    ...
    path('faculty', views.FacultyPost, name='faculty'),
    path('faculty/<int:pk>/', FacultyPostDetailView.as_view(), name='faculty_post_detail'),
    path('faculty/edit/<int:pk>/', FacultyPostEditView.as_view(), name='faculty_post_edit'),
    path('faculty/delete/<int:pk>/', FacultyPostDeleteView.as_view(), name='faculty_post_delete'),
    path('faculty/<int:post_pk>/comment/delete/<int:pk>/', FacultyCommentDeleteView.as_view(), name='faculty_comment_delete'),
